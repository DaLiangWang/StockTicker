 ...
 * configuration so every API client shares the same lenient JSON handling.
 */
 ...
 * engine is picked up from the classpath of the consuming platform (OkHttp on Android).
 */
